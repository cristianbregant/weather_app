      ...
      child: Column(children: [
        ...
        SettingsCategory(title: "Preferences", items: [
          SettingsRow(
            child: ListTile(
              dense: true,
              trailing: Text(context.watch<AppConfigProvider>().unit.tempLabel),
              onTap: () {
                          ...
                          children: <Widget>[
                            Row(
                              children: const [
                                Expanded(
                                  child: Padding(
                                    padding:
                                        EdgeInsets.fromLTRB(8.0, 16, 16, 16),
                                    child: Text(
                                      "Temperature units",
                                      style: TextStyle(
                                          fontSize: 24,
                            ...
                            ...Units.values.map((t) {
                              return RadioListTile<Units>(
                                  ...
                                  groupValue:
                                      context.watch<AppConfigProvider>().unit,
                                  onChanged: (Units? v) {
                                    context
            ...
            child: ListTile(
              ...
              trailing: CupertinoSwitch(
                ...
                onChanged: (value) {
                  setState(() {
                    if (value) {
                      Utils.settingsController!.updateThemeMode(ThemeMode.dark);
                    } else {
